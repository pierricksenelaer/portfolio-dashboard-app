...
const variantClasses: Record<ButtonVariant, string> = {
  primary: 'bg-theme-primary-600 text-white hover:bg-theme-primary-700 focus:ring-4 focus:ring-theme-primary-500/50 dark:bg-theme-primary-700 dark:hover:bg-theme-primary-600 px-4 py-2 text-sm',
...
export const Button: React.FC<ButtonProps> = ({
  ...
  return (
    ...
    >
      {isLoading ? (
        <svg 
          className="animate-spin -ml-1 mr-3 h-5 w-5 text-theme-primary-50" 
